            ...
            <div class="container-fluid js-container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        <li role="button" onclick="changeLang('pt')"><span style="color:#ff8300">Espa&ntilde;ol</span><span> / </span><span>Portugu&eacute;s</span></li>
                        <li class="dropdown">
        ...
        <section id="contacto" class="js-section">
            <div class="js-container">
                <div class="js-contacto text-center">
                   ...
                   <a href="Registros" target="_blank" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect js-button">&Uacute;nete a nuestro programa</a>
                </div>
            </div>
        </section>
